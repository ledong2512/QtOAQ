/****************************************************************************
** Meta object code from reading C++ file 'Confirm.hpp'
**
...
#error "The header file 'Confirm.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 8, 13), // "confirmSignal"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 11) // "emitConfirm"

    },
    "Confirm\0confirmSignal\0\0emitConfirm"
};
...
void Confirm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->confirmSignal(); break;
        case 1: _t->emitConfirm(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Confirm::confirmSignal)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Confirm::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Confirm.data,
    qt_meta_data_Confirm,
    qt_static_metacall,
    nullptr,
    nullptr
} };
